...
# Solscan public API to fetch wallet tokens
SOLSCAN_API = "https://public-api.solscan.io/account/tokens?address={}&limit=100"
...
def fetch_tokens(wallet_address: str) -> List[Dict]:
    """Fetch SPL tokens from a Solana wallet via Solscan"""
    try:
        print("Fetching tokens from wallet...")
        response = requests.get(SOLSCAN_API.format(wallet_address), headers=HEADERS)
